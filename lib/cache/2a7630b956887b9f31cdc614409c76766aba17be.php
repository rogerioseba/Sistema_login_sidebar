                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <form method="post" action="update_profile" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="sexo_pet" type="text" class="form-control" id="sexo_pet" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="logradouro" class="col-md-4 col-lg-3 col-form-label">Logradouro</label>
                                            <div class="col-md-8 col-lg-9">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="telefone" type="text" class="form-control" id="Phone" value="">
                                            </div>
                                        </div>
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\login\views/edit_tag.blade.php ENDPATH**/ ?>
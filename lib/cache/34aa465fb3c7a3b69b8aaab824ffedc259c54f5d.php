                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Entrar na sua Tag Conta</h5>
                                    <p class="text-center small">Digite seu usuário & senha para entrar</p>
                                </div>

                                <form class="row g-3 needs-validation" novalidate method="post" action="entrar">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0"><a href="recover-pass">Esqueci minha senha!</a></p>
                                    </div>
                                    <div class="col-12">
...
</html><?php /**PATH C:\xampp\htdocs\Tippet_Tag\views/login.blade.php ENDPATH**/ ?>
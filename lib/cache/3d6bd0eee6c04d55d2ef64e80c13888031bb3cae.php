                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Criar sua Conta</h5>
                                    <p class="text-center small">Entre com seus dados pessoais para criar a conta!</p>
                                </div>

                                <form class="row g-3 needs-validation" novalidate method="post" action="create_account">
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Seu Primeiro Nome</label>
                                    ...
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Seu Sobrenome</label>
                                        <input type="text" name="last_name" class="form-control" id="yourName" required>
                                        <div class="invalid-feedback">Por favor, digite seu sobrenome!</div>
                                    </div>

                                    <div class="col-12">
                                        <label for="yourEmail" class="form-label">Seu Email</label>
                                        <input type="email" name="email" class="form-control" id="yourEmail" required>
                                        <div class="invalid-feedback">Por favor, entre com um e-mail válido!</div>
                                    </div>

                                    <div class="col-12">
                                        <label for="yourPassword" class="form-label">Nova Senha</label>
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Já possui uma conta? <a href="login">Log in</a></p>
                                    </div>
                                </form>
...
</html><?php /**PATH C:\xampp\htdocs\Tippet_Tag\views/pages-register.blade.php ENDPATH**/ ?>
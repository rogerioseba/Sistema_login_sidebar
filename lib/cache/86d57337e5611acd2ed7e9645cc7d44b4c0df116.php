...
<?php if($_SESSION['imagem_tutor']=="IMAGE_DEFAULT" || $_SESSION['imagem_tutor']==null): ?>
                                <img src="assets/img/avatar.png" alt="Profile" class="rounded-circle">
                            <?php else: ?>
                                <img src="data:image/jpeg;base64,<?php echo e($_SESSION['imagem_tutor']); ?>" alt="Profile" class="rounded-circle">
                            <?php endif; ?>

                            <h2>Tutor: <?php echo e($_SESSION['first_name']); ?></h2>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo e($_SESSION['first_name']." ".$_SESSION['last_name']); ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Email</div>
                                        <div class="col-lg-9 col-md-8"><?php echo e($_SESSION['email']); ?></div>
                                    </div>

                                    <form method="post" id="delete_conta" class="mt-2" action="delete_user">
                                        <input type="hidden" name="idusers" value="<?php echo e($_SESSION['iduser']); ?>">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form method="post" action="update_user" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="first_name" type="text" class="form-control" id="first_name" value="<?php echo e($_SESSION['first_name']); ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="last_name" class="col-md-4 col-lg-3 col-form-label">Seu Sobrenome</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="last_name" type="text" class="form-control" id="last_name" value="<?php echo e($_SESSION['last_name']); ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="Email" class="col-md-4 col-lg-3 col-form-label">Email</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="email" type="email" class="form-control" id="Email" value="<?php echo e($_SESSION['email']); ?>">
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tippet_Tag\views/home.blade.php ENDPATH**/ ?>